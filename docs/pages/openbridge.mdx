...
The implementation of the ERC7786OpenBridge is available [here](https://github.com/OpenZeppelin/openzeppelin-community-contracts/blob/master/contracts/crosschain/ERC7786Aggregator.sol).
